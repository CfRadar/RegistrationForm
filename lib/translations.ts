...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    form: {
      ...
      emailPlaceholder: 'yourname@ietdavv.edu.in',
      emailNote: 'Enter your official college email address',
  ...
  hi: {
    ...
    form: {
      ...
      emailLabel: 'कॉलेज ईमेल आईडी',
      emailPlaceholder: 'yourname@ietdavv.edu.in',
      emailNote: 'अपनी आधिकारिक कॉलेज ईमेल आईडी दर्ज करें',
